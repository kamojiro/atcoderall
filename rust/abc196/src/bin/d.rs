...
fn main() {
    ...
    hanjo(&mut board, &mut ans, A, B, H,W,A,B);
    println!("{}", ans);
    
}

fn hanjo(board: &mut Vec<Vec<bool>>, ans: &mut usize, x: usize, y: usize, H: usize, W: usize, A: usize, B: usize){
    if x == 0 && y == 0{
        *ans += 1;
        return
    }
