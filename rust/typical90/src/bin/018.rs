...
fn main() {
    ...
    for &e in &E{
        let e869120 = (0.0, - L*(2.0*pi*e/T).sin()/2.0, L/2.0 - L*(2.0*pi*e/T).cos()/2.0);
        let d = ((chokudai.0 - e869120.0).powi(2) + (chokudai.1 - e869120.1).powi(2)).powf(0.5);
        println!("{}", (e869120.2/d).atan().to_degrees());
